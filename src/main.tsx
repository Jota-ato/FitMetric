...
import RegistationForm from './components/Pages/RegistrationPageComponents/RegistationForm.tsx'
import DetailInformationForm from './components/Pages/RegistrationPageComponents/DetailInformationForm.tsx'
            ...
            <Routes>
                ...
                <Route element={<Layout />}>
                    ...
                    <Route path="diary" element={<DiaryComponent />}>
                        <Route path=":mealType/searchFood" element={<SearchFood />} />
                        <Route path=":mealType/foodDetail/:id" element={<FoodDetail />} />
                    </Route>
